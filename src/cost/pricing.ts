...
export const PRICING: Record<string, ModelPricing> = {
  ...
  // Google Gemini 3.1 Flash-Lite — $0.25 / $1.50 per 1M. Curate stage
  // default since 2026-05-31 (replaced gemini-3.5-flash, which truncated
  // its JSON output under default-high thinking). config/litellm.yaml +
  // src/scoring/curate.ts.
  'gemini-3.1-flash-lite': { inputUsdPerToken: 0.25 / M, outputUsdPerToken: 1.5 / M },
  // Google Gemini 3.5 Flash — $1.50 / $9.00 per 1M. Was the curate
  // default 2026-05-28 → 2026-05-31; kept routed as a fallback / for A/B.
